"""autogenerated by genpy from quadrotor_msgs_ep/SO3Command.msg. Do not edit."""
import sys
...
float64[3] kR
float64[3] kOm
quadrotor_msgs_ep/AuxCommand aux
...
================================================================================
MSG: quadrotor_msgs_ep/AuxCommand
float64 current_yaw
...
"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Quaternion','float64[3]','float64[3]','quadrotor_msgs_ep/AuxCommand']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.kOm is None:
        self.kOm = [0.,0.,0.]
      if self.aux is None:
        self.aux = quadrotor_msgs_ep.msg.AuxCommand()
    else:
      self.header = std_msgs.msg.Header()
      self.force = geometry_msgs.msg.Vector3()
      self.orientation = geometry_msgs.msg.Quaternion()
