...
#include <quadrotor_msgs_ep/Corrections.h>
...
private:
  ...
  void position_cmd_callback(
      const quadrotor_msgs_ep::PositionCommand::ConstPtr &cmd);
  void odom_callback(const nav_msgs::Odometry::ConstPtr &odom);
  void enable_motors_callback(const std_msgs::Bool::ConstPtr &msg);
  void corrections_callback(const quadrotor_msgs_ep::Corrections::ConstPtr &msg);
...
void SO3ControlNodelet::publishSO3Command(void)
{
  ...
  quadrotor_msgs_ep::SO3Command::Ptr so3_command(
      new quadrotor_msgs_ep::SO3Command); //! @note memory leak?
...
void SO3ControlNodelet::corrections_callback(
    const quadrotor_msgs_ep::Corrections::ConstPtr &msg)
{
...
void SO3ControlNodelet::onInit(void)
{
  ...
  so3_command_pub_ = n.advertise<quadrotor_msgs_ep::SO3Command>("so3_cmd", 10);
